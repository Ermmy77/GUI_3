...
# creates a sign-up button which saves the username and password and also closes the window when clicked
sign_up_button = Button(sign_up, text="Sign In", fg="black", command=lambda: [save_username(), save_password()])
